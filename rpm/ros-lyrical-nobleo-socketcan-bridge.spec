...
%global pkg_name nobleo_socketcan_bridge
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-nobleo-socketcan-bridge
Version:        1.0.4
Release:        3%{?dist}
...
%changelog
* Wed Apr 29 2026 Ramon Wijnands <ramon.wijnands@nobleo.nl> - 1.0.4-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Ramon Wijnands <ramon.wijnands@nobleo.nl> - 1.0.4-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Ramon Wijnands <ramon.wijnands@nobleo.nl> - 1.0.4-1
- Autogenerated by Bloom
